...
function CreateActionBar()
{
    ...
    c0 = "#f48542"
    c0 = utils.RandomHexColor(false);
    app.WriteFile( "colors-log.txt", c0 + "\r\n", "Append" );
    c1 = utils.HexToDarkerHex(c0, 0.25);
    c2 = utils.HexToLighterHex(c0, 0.25);
    c3 = utils.HexToLighterHex(c0, 0.50);

    layHoriz.SetBackGradient(c2, c1, c0);
...
function CreateDrawer()
{
	...
	var img = app.CreateImage( "Img/Ibeb.png", 0.45 );
